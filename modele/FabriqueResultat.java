...
public class FabriqueResultat {
    public static Resultat creerResultat(String path) {
        String dirPath;
        if (ControlRechercher.getFileExtension(path).equals("xml") || ControlRechercher.getFileExtension(path).equals("")){
        ...
        resultat.setMoteurs(Moteurs.getMoteursActifs());
        return resultat;
    }
}
